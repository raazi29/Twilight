                    ...
                    <div className="space-y-8">
                        <div>
                            <h1 className="text-4xl font-bold text-white leading-tight mb-4">
                                Driver Payments
                                <br />
                                <span className="text-twilight-green-400">Made Simple</span>
                            </h1>
                            <p className="text-lg text-white/70 max-w-md leading-relaxed">
                                Streamline your fleet&apos;s payment operations with transparent Batta and Salary tracking.
                            </p>
                        </div>
            ...
            <div className="flex flex-1 items-center justify-center p-8 bg-[var(--background)]">
                <div className="w-full max-w-[400px] space-y-8">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-[var(--foreground-muted)] mt-2">Sign in to manage driver payments</p>
                    </div>
